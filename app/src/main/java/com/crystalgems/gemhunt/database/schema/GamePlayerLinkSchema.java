...
public interface GamePlayerLinkSchema {
    ...
    String[] GAME_PLAYER_LINK_COLUMNS = new String[] {COLUMN_GAME_PLAYER_LINK_ID, COLUMN_GAME_PLAYER_LINk_ID_GAME, COLUMN_GAME_PLAYER_LINk_ID_PLAYER, COLUMN_GAME_PLAYER_LINk_PLAYER_SCORE, COLUMN_GAME_PLAYER_LINk_PLAYER_RANK};
